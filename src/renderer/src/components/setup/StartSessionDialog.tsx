  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        <DialogDescription>
          Kestrel will capture your microphone and the other party's audio, transcribe both, and
          suggest answers.
        </DialogDescription>
        <div className="space-y-1">
          ...
          <Select
            options={[
              { value: '', label: 'No profile (generic answers)' },
        ...
        <label className="flex cursor-pointer items-start gap-2 rounded-md border border-border p-2.5 text-xs">
          ...
          <span>
            ...
            Participants are aware of this recording/transcription, or this use is permitted by the
            platform and my local laws.
          </span>
        </label>
