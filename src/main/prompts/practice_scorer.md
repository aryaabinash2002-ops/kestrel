...
- `model_answer`: a strong answer of 80–140 words the candidate could realistically give, using only facts from the résumé/story bank (never invent employers, titles, dates or metrics).
- `strengths`: 1–3 short bullets.

Role: {role} at {company}. Interview type: {interview_type}.
